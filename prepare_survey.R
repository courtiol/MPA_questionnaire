...
<a href='https://www.izw-berlin.de/en/' target='_blank'>the Leibniz-IZW</a>,
<a href='https://iucn.org/our-union/commissions/world-commission-protected-areas/' target='_blank'>the IUCN World Commission on Protected Areas</a>,
<a href='https://www.rewild.org/' target='_blank'>Re:wild</a>, and
...
<ul class='flex-container'>
  ...
  <li><img src='https://workforce-admin.marine-conservation.org/assets/tmp/admin/GT6V7rzDbi_TUiVJfha0/IUCN_WCPA_en.png?v1745308701' alt=IUCN WCPA logo' style='height:140px;'></li>
  <li><img src='https://workforce-admin.marine-conservation.org/assets/tmp/admin/GT6V7rzDbi_TUiVJfha0/Re_wild_Logo_Reg.png?v1745308701' alt='re:wild logo' style='height:100px;'></li>
</ul>",
type = "note",
name = "logos")
